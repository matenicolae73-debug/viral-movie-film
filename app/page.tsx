...
export default function Home() {
  ...
  async function ownerLogin() {
    ...
    setOwnerLoggedIn(true); setPublishMessage("Owner access verified on this browser.");
  }
